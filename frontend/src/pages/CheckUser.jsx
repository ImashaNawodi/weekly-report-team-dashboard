...
export default function CheckUser() {
  ...
  <div className="absolute right-[15%] bottom-[20%] h-32 w-32 rounded-full bg-blue-500/20 blur-2xl" />
    ...
    <div className="relative overflow-hidden rounded-2xl border border-blue-100 bg-white p-7 shadow-[0_20px_50px_rgba(37,99,235,0.10)] transition-all duration-300 hover:border-blue-200 hover:shadow-[0_25px_60px_rgba(37,99,235,0.15)]">
      ...
      <div className="relative z-10">
        ...
        <div>
          ...
          {error && (
            <div className="mt-5 flex items-start gap-2.5 rounded-lg border border-red-200 bg-red-50 px-4 py-3 shadow-sm">
              <AlertCircle
          ...
          >
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full rounded-lg border bg-white py-2.5 pl-10 pr-3 text-sm text-slate-900 placeholder:text-slate-400 transition-all duration-200 focus:outline-none focus:ring-2 ${
                    fieldError
                      ? "border-red-300 focus:border-red-400 focus:ring-red-100"
                      : "border-slate-200 hover:border-blue-300 focus:border-blue-500 focus:ring-blue-100"
                  }`}
            ...
            <button
              type="submit"
              disabled={loading}
              className="group flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 px-4 py-2.5 text-sm font-semibold text-white shadow-md shadow-blue-500/20 transition-all duration-200 hover:-translate-y-0.5 hover:from-blue-700 hover:to-indigo-700 hover:shadow-lg hover:shadow-blue-500/25 focus:outline-none focus:ring-2 focus:ring-blue-200 focus:ring-offset-1 active:translate-y-0 disabled:cursor-not-allowed disabled:opacity-70 disabled:hover:translate-y-0"
            >
              {loading ? (
                <>
                  <svg
